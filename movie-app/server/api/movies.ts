...
export default defineEventHandler((event) => {
  ...
  const allMovies = [
    ...
    // ===== DANH MỤC 2: PHIM KINH ĐIỂN (10 PHIM) =====
    ...
    // ===== DANH MỤC 3: PHIM KINH ĐIỂN II (10 PHIM) =====
    ...
    // ===== DANH MỤC 4: PHIM TRENDING & SIÊU ANH HÙNG (10 PHIM) =====
    ...
    // ===== DANH MỤC 5: PHIM RẠP MỚI CHIẾU (10 PHIM) =====
