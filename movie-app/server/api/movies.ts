...
export default defineEventHandler(async (event) => {
  ...
  const allMovies = [
    ...
    {"movie": {"id": 1, "title": "Lat mat 7", "poster": "/images/posters/lat-mat-7.jpg", "year": "2024", "genre": "Tâm Lý, Gia Đình", "rating": 9.0, "synopsis": "Câu chuyện xoay quanh những ước mơ, tình yêu và gia đình trong bối cảnh Việt Nam hiện đại. Khi một người đàn ông quay lại quê nhà, anh phải đối mặt với những lựa chọn khó khăn và tái kết nối với những người thân yêu.", "trailerUrl": "https://www.youtube.com/embed/dQw4w9WgXcQ"}, "favoriteAt": "2024-06-01T12:00:00Z"},
